var GameView = Backbone.View
    .extend({
      ...
      initialize : function() {
        ...
        this.gameViewScoreBoardTemplate = _.template(tpl
            .get('gameViewScoreBoardTemplate'));
        this.gameViewCommentListTemplate = _.template(tpl
      ...
      renderRefresh : function() {
        ...
        // On rafraichit tout
        $(this.displayViewScoreBoard).html(
            _.template(this.gameViewScoreBoardTemplate({
        ...
        if (this.scoreboard.toJSON().stream !== undefined)
          $(this.incomingComment).html(
              _.template(this.gameViewCommentListTemplate({
