var GameAddView = Backbone.View
    .extend({
      ...
      initialize : function() {
        ...
        this.playerListAutoCompleteViewTemplate = _.template(tpl
            .get('playerListAutoCompleteViewTemplate'));
      ...
      displayTeam1 : function(li) {
        ...
        selectedRank = $('#team1_choice:checked').next('label').next('label')
            .text();
      ...
      displayTeam2 : function(li) {
        ...
        selectedRank = $('#team2_choice:checked').next('label').next('label')
            .text();
        // $('label[for=pre-payment]').text();
      ...
      fetchCollection : function() {
        ...
        /*
         * this.userCollection.fetch({ url:
         * serviceURLPlayers+'97e2f09341b45294f3cd2699', success: function() {
      ...
      renderListTeam1 : function() {
        var q = $("#team1").val();
        $(this.listview1).html(
            _.template(this.playerListAutoCompleteViewTemplate({
              players : this.playersTeam1.toJSON(),
              query : q,
              select : 1
            })));
        $(this.listview1).listview('refresh');
      ...
      renderListTeam2 : function() {
        ...
        $(this.listview2).html(
            _.template(this.playerListAutoCompleteViewTemplate({
              players : this.playersTeam2.toJSON(),
              query : q,
              select : 2
            })));
        $(this.listview2).listview('refresh');
      ...
      addGame : function(event) {
        ...
        // var id = $('#id').val(),
        var team1 = $('#team1').val(), rank1 = $('#rank1').val(), team1_id = $(
            '#team1_id').val(), team2 = $('#team2').val(), rank2 = $('#rank2')
            .val(), team2_id = $('#team2_id').val(), city = $('#city').val(), playerid = $(
            '#playerid').val(), token = $('#token').val(), court = $('#court')
            .val(), surface = $('#surface').val(), tour = $('#tour').val(), subtype = $(
            '#subtype').val(), game = null;
        ...
        if (rank1 === '') {
          ...
          $('span.team1_error').html('Vous devez indiquer le classement !')
              .show();
          return false;
        }
        ...
        if (rank2 === '') {
          ...
          $('span.team2_error').html('Vous devez indiquer le classement !')
              .show();
          return false;
        }
        ...
        /*
         * var game = { team1:team1, team2:team2, team1_id:team1_id,
         * team2_id:team2_id, city: city, playerid: playerid, court: court,
         * surface: surface, subtype: subtype, tour: tour, token: token };
         */
        ...
        // games.storage.sync.push(); // POST /api/dreams and PUT
        // /api/dreams/:id
      ...
      render : function() {
        ...
        this.$el.html(_.template(this.gameAddTemplate({
      ...
      onClose : function() {
        ...
        if (this.playersTeam1 !== undefined)
          this.playersTeam1.off("all", this.renderListTeam1, this);
        if (this.playersTeam2 !== undefined)
          this.playersTeam2.off("all", this.renderListTeam2, this);
