var PlayerFollowView = Backbone.View
    .extend({
      ...
      initialize : function() {
        ...
        this.playerListViewTemplate = _.template(tpl
            .get('playerListViewTemplate'));
        ...
        // On cherche que
        this.playersfollow = new PlayersCollection(this.playersfollow.storage
            .findAll({
              local : true
            }));
      ...
      search : function() {
        ...
        $(this.listview).html(_.template(playerListViewTemplate, {
          players : this.playersfollow.toJSON(),
          query : q
        }));
      ...
      renderList : function(query) {
        ...
        $(this.listview).html(_.template(this.playerListViewTemplate({
          players : this.playersfollow.toJSON(),
          query : ' '
        })));
