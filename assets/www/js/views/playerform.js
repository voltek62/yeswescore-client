var PlayerFormView = Backbone.View
    .extend({
      ...
      initialize : function() {
        ...
        this.clubListAutoCompleteViewTemplate = _.template(tpl
            .get('clubListAutoCompleteViewTemplate'));
      ...
      updateList : function(event) {
        ...
        // $(this.listview).html('<li><a href="" data-transition="slide">Club
        // 1</a></li>');
      ...
      renderList : function() {
        ...
        $(this.listview).html(
            _.template(this.clubListAutoCompleteViewTemplate({
      ...
      add : function(event) {
        ...
        var name = $('#name').val(), nickname = $('#nickname').val(), password = $(
            '#password').val(), email = $('#email').val(), rank = $('#rank')
            .val(), playerid = $('#playerid').val(), token = $('#token').val(), club = $(
            '#club').val(), clubid = $('#clubid').val(), idlicense = $(
            '#idlicense').val(), player = null;
